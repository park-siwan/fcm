...
const message = {
  message: {
    token:
      ...
      'fwZUoByFR_udppde3cv7tJ:APA91bFmQxYiMxjsw6n8PbBo1Q3PtMKckDzlzqIrZfvldQvjw3fZ_uDPXYbyHU2R3S13ma2_BnVbi31dyyfk0hyVIFh-fFCFiagM2R_BeRGpGPhnyv_IGsM', //시완 웹뷰
    // notification: {
    //   title: '응급상황(낙상감지)',
    ...
    data: {
      title: '응급상황(낙상감지)',
      body: '참여자의 낙상이 감지되었습니다.',
      target_url: 'https://smartboardtest.inhandplus.com/ko/participant-info',
    },
  },
};
